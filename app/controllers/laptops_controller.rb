class LaptopsController < ApplicationController
  ...
  def destroy
    @rv=Laptop.last
     @rv.delele
  #   redirect_to laptops_url(@laptop)

     #(laptop_params)
    # respond_to do |format|
    #   format.html { redirect_to laptops_url(@laptop), notice: "Laptop was successfully destroyed." }
  ...
  private
    ...
    def laptop_params
      params.require(:laptop).permit(:name, :cost)
    end
end
